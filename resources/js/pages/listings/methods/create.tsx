                ...
                <form onSubmit={handleSubmit} className='space-y-6 py-4'>
                    <div className='grid grid-cols-4 items-center gap-4'>
                        ...
                        <div className='col-span-3'>
                            <Input id='lot' value={values.lot} onChange={handleChange} className='w-full' isInvalid={Boolean(errors.lot)} />
                    ...
                    <div className='grid grid-cols-4 items-center gap-4'>
                        ...
                        <div className='col-span-3'>
                            <Input id='title' value={values.title} onChange={handleChange} className='w-full' isInvalid={Boolean(errors.title)} />
                            {errors.title && <span className='text-sm text-red-500'>{errors.title}</span>}
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-4 items-center gap-4'>
                        ...
                        <div className='col-span-3'>
                            ...
                            />
                            {errors.sale_order && <span className='text-sm text-red-500'>{errors.sale_order}</span>}
                        </div>
                    </div>
                    <div className='grid grid-cols-4 items-center gap-4'>
                        ...
                        <div className='col-span-3'>
                            ...
                            />
                            {errors.estimate && <span className='text-sm text-red-500'>{errors.estimate}</span>}
                        </div>
                    </div>
                    <DialogFooter>
